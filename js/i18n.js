...
const I18N = {
  uk: {
    ...
    caption: {
      ...
      finalBudget: "Підсумкові дані вступної кампанії {year} року. Лише бюджетні місця за відкритим конкурсом (без пільгових/фіксованих і контрактних місць) на програми з журналістики; заклади освіти щонайменше з {minApps} поданими заявами.",
      liveBudget: "Станом на {date}. Лише бюджетні місця за відкритим конкурсом (без пільгових/фіксованих і контрактних місць) на програми з журналістики; заклади освіти щонайменше з {minApps} поданими заявами.",
      finalBudgetPriority: "Підсумкові дані вступної кампанії {year} року. Лише заяви 1-го та 2-го пріоритету на бюджетні місця за відкритим конкурсом (без пільгових/фіксованих і контрактних місць) на програми з журналістики; заклади освіти щонайменше з {minApps} поданими заявами.",
      liveBudgetPriority: "Станом на {date}. Лише заяви 1-го та 2-го пріоритету на бюджетні місця за відкритим конкурсом (без пільгових/фіксованих і контрактних місць) на програми з журналістики; заклади освіти щонайменше з {minApps} поданими заявами."
    },
    table: {
      institution: "Заклад",
      score: "Середній бал",
  ...
  en: {
    ...
    caption: {
      ...
      finalBudget: "Final data for the {year} admissions campaign. Only budget places filled through open competition (excluding quota/fixed and contract places) for journalism programs; institutions with at least {minApps} submitted applications.",
      liveBudget: "As of {date}. Only budget places filled through open competition (excluding quota/fixed and contract places) for journalism programs; institutions with at least {minApps} submitted applications.",
      finalBudgetPriority: "Final data for the {year} admissions campaign. Only 1st and 2nd priority applications to budget places filled through open competition (excluding quota/fixed and contract places) for journalism programs; institutions with at least {minApps} submitted applications.",
      liveBudgetPriority: "As of {date}. Only 1st and 2nd priority applications to budget places filled through open competition (excluding quota/fixed and contract places) for journalism programs; institutions with at least {minApps} submitted applications."
    },
    table: {
