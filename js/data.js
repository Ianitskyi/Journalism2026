...
/* 2026 показуємо: попередній рейтинг за кількістю поданих заяв (усі
   конкурсні пропозиції спеціальності C7/061, дані ЄДЕБО через osvita.ua,
   усі заклади включно з приватними/контрактними). Середній бал вступників
   поки не зібрано (score:null); перемикачі «лише бюджет»/«1-2 пріоритет»
   для 2026 приховані, бо розбивок ще немає. Поставити false, щоб сховати. */
const SHOW_CURRENT_YEAR = true;
