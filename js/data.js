...
/* 2026 тимчасово прихований. Наявні дані 2026 — лише бюджетний звіт
   (адресне розміщення держзамовлення): у них немає приватних/контрактних
   закладів (напр. УКУ) і рахуються тільки бюджетні заяви, а не всі, тож
   вони не порівнювані з 2021–2025. Повернути true, коли зберемо всі заяви
   по всіх конкурсних пропозиціях (метрика st.c.t), як за попередні роки. */
