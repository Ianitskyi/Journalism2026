...
/* Кампанія 2026 завершилася; показуємо попередній рейтинг за кількістю
   заяв (середній бал вступників додамо, коли з'явиться джерело — тоді
   колонка балів заповниться сама). Поставити false, щоб знову сховати
   2026 з рейтингу, таблиць і графіків. */
